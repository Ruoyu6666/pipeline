...
from engine.engine_linprobe import train_one_epoch, evaluate
...
def get_args_parser():
    ...
    parser.add_argument('--enable_amp', action='store_true', default=False, help='Enabling automatic mixed precision')
    ...
    parser.add_argument('--output_dir', default='./linear_output_dir', help='path where to save, empty for no saving')
    parser.add_argument('--log_dir', default='./linear_output_dir', help='path where to tensorboard log')
