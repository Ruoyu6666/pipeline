...
def get_args_parser():
    ...
    parser.add_argument('--mask_ratio_inter', default=0.75, type=float, help='Masking ratio inter (percentage of removed patches).')
    parser.add_argument('--mask_ratio_intra', default=0.80, type=float, help='Masking ratio intra (percentage of removed patches).')
