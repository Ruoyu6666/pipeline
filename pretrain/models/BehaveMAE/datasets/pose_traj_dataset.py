...
class BasePoseTrajDataset(torch.utils.data.Dataset):
    ...
    def normalize(self, data):
        ...
        state_dim = data.shape[1] // 2 # data.shape (900, 72)
    ...
    def prepare_subsequence_sample(self, sequence: np.ndarray):
        ...
        if self.augmentations:
            ...
            sequence = sequence.reshape(self.max_keypoints_len, -1)  # sequence  (900, 72)
        feats = self.featurise_keypoints(sequence) # (900, 72)
